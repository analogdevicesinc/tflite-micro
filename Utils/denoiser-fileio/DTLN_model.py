...
#conversion works best with tf 2.16.0rc0
...
in1_data = np.load(file='input1.npy')
st1_data = np.load(file='state1.npy')
in2_data = np.load(file='input2.npy')
st2_data = np.load(file='state2.npy')
...
class DTLN_model():
    ...
    def create_tf_lite_model(self, weights_file, target_name, use_dynamic_range_quant=False):
        ...
        if use_dynamic_range_quant:
            ...
            converter.representative_dataset = representative_dataset1
...
class InstantLayerNormalization(Layer):
    ...
    def call(self, inputs):
        ...
        '''
        outputs = inputs #do nothing as this steps fails for int16
        '''
