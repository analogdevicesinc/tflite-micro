...
/* ADD_ELWISE_THRESHOLD: Input length above which OPT code performs better than  REF code for Elementwise ADD.
 * Found through experimentation
 * */
#define ADD_ELWISE_THRESHOLD 60

void AddElementWise(const int16_t* input_1, const int16_t* input_2, int n_batch,
        int n_input, int16_t* output) {
#ifdef USE_OPTIMIZED_LSTM
    if (n_input > ADD_ELWISE_THRESHOLD)
    {
        adi_sharcfx_elementwise_add_int16(  input_1,
                                            input_2,
                                            n_batch,
                                            n_input,
                                            output,
...
void Mul(const RuntimeShape& shape, const ArithmeticParams& params,
        ...
        int16_t* output_data) {
#ifdef USE_OPTIMIZED_LSTM
    adi_sharcfx_elementwise_mul_int16(  input1_data,
                                        input2_data,
                                        output_data,
                                        shape.FlatSize(),
                                        params.output_multiplier,
...
void FullyConnected(const FullyConnectedParams& params,
        ...
        const RuntimeShape& output_shape, int16_t* output_data) {
#ifdef USE_OPTIMIZED_LSTM
FullyConnectedParams params_read = params;
    adi_sharcfx_fully_connected_int16(  (const int16_t*)input_data,
