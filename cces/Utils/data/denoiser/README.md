...
The sample audio file needs to be converted into binary file with 16KHz sampling rate and the binary file needs to be placed in `cces\examples\denoiser\denoiser_fileio\src\input` as `noisy_audio.bin`.
