...
The sample audio file needs to be converted into binary file with 16KHz sampling rate and the binary file needs to be placed in `cces\examples\keyword_spotter\kws_fileio\src\input` as `keyword_audio.bin`.
