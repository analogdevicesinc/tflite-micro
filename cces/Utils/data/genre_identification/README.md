...
The sample audio file needs to be converted into binary file with 48KHz sampling rate and the binary file needs to be placed in `cces\examples\genre_identification\genre_id_fileio\src\input` as `genre_audio.bin`.
...
Example: `python convert_wav_to_bin.py "..\genre_identification\sample_data\newage_folk_electronic_classical_30sec.wav" "..\..\..\examples\genre_identification\genre_id_fileio\src\input\genre_audio.bin" 48000`
