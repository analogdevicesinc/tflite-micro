...
The sample audio file needs to be converted into C++ data structure and placed in `cces\examples\micro_speech\src\testdata` as `micro_speech_audio_data.cc` and `micro_speech_audio_data.h`.
