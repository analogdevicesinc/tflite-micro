/* This linker script generated from xt-genldscripts.tpp for LSP C:\Work\BootROM\EHP2\CCES_Project\Program Flash Bare Metal\SPI_1_LPC\system\startup_lsp\lsp */
/* Linker Script for default link */
MEMORY
{
  L2_ram_seg :                        	org = 0x20000000, len = 0x1FE000
  L2_boot_noload_seg :                	org = 0x201FE000, len = 0x2000
  L1_data_seg :                       	org = 0x2F780000, len = 0x80000
  L1_code_seg :                       	org = 0x2F800000, len = 0x10000
  L3_ram_seg :                        	org = 0x80000000, len = 0x40000000
}

PHDRS
{
  L2_ram_phdr PT_LOAD;
  L2_ram_bss_phdr PT_LOAD;
...
_memmap_seg_L2_ram_start = 0x20000000;
_memmap_seg_L2_ram_max   = 0x201fe000;
...
_memmap_seg_L3_ram_start = 0x80000000;
_memmap_seg_L3_ram_max   = 0xc0000000;
...
SECTIONS
{
  ...
  .bss (NOLOAD) : ALIGN(8)
  {
    ...
    *(.sram0.bss)
    . = ALIGN (8);
    _bss_end = ABSOLUTE(.);
    _memmap_seg_L2_ram_end = ALIGN(0x8);
  } >L2_ram_seg :L2_ram_bss_phdr
  ...
  .L3.bss (NOLOAD) : ALIGN(8)
  {
    ...
    *(.L3.bss)
    ...
    _memmap_seg_L3_ram_end = ALIGN(0x8);
  } >L3_ram_seg :L3_ram_bss_phdr
