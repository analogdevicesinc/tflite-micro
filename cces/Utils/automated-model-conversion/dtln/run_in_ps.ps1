...
if((Test-Path -Path $final_float_model_path\$tflm_f_model1a) -and (Test-Path -Path $final_float_model_path\$tflm_f_model1b) -and (Test-Path -Path $final_float_model_path\$tflm_f_model2a) -and (Test-Path -Path $final_float_model_path\$tflm_f_model2b)){
