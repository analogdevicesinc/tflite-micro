...
$env="python_env"
$tflite_model_float32="float32_urbansound_ID.tflite"
$tflite_model_int8="int8_urbansound_ID.tflite"
$tflm_models="TFLM_models"
$tflm_model1a="float32_urbansound_ID_model_data.h"
$tflm_model1b="float32_urbansound_ID_model_data.cc"
$tflm_model2a="int8_urbansound_ID_model_data.h"
$tflm_model2b="int8_urbansound_ID_model_data.cc"

$final_int8_model_path="../../../examples/urbansound_classification/common/model/int8_urbansound_ID/"
$final_float_model_path="../../../examples/urbansound_classification/common/model/float32_urbansound_ID/"
...
if((Test-Path -Path $final_int8_model_path\$tflm_model2a) -and (Test-Path -Path $final_int8_model_path\$tflm_model2b)){
