...
* Expected Input: Follow the Readme in `cces\Utils\data\genre_identification` to download and use the input file. You can use any custom music file of your choise for testing.

### Headless build and flash
To quickstart the genre_id example, this project allows headless building and flashing of the application.
