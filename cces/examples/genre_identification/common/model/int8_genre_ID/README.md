This folder contains the INT8 quantized model for genre identification.
...
> Run the conversion script in `cces/Utils/automated-model-conversion/genre_identification/` to regenerate
