...
void adi_urbansound_id_model_setup() {
  ...
  if (kTfLiteOk != OpenInputFile()) {
	  PRINT_INFO("\nFailed to read the input file. Check if the urbansound_audio.bin is available in input folder.Refer urbansound_identification/Readme.\n");
	  exit(0);
  }
#endif
