...
uint8_t tensor_arena[kTensorArenaSize]__attribute__((section(".L1.data"), aligned(16)));
int8_t feature_buffer[kFeatureElementCount]__attribute__((section(".L1.data"), aligned(16)));
