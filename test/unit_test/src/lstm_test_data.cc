...
NodeQuantizationParameters Get2X2Int8LstmQuantizationSettings() {
  ...
  quantization_settings.input = {/*scale=*/0.00784313725490196, /*zp=*/0,		/*zp here, refers to zero point*/
                                 /*symmetry=*/false};
...
NodeQuantizationParameters Get2X2Int16LstmQuantizationSettings_CustomTest1() {
  NodeQuantizationParameters quantization_settings;
  quantization_settings.activation_type = kTfLiteInt16;
  quantization_settings.weight_type = kTfLiteInt8;
  quantization_settings.cell_type = kTfLiteInt16;
  ...
  // state quantization parameters
  quantization_settings.input = {/*scale=*/3.0518044e-1, /*zp=*/0,
                                 /*symmetry=*/true};
  quantization_settings.output = {/*scale=*/2.1362956633198035e-01, /*zp=*/0,
                                  /*symmetry=*/true};
  quantization_settings.hidden_state = {/*scale=*/2.1362956633198035e-02,
                                        /*zp=*/0,
                                        /*symmetry=*/true};
  quantization_settings.cell_state = {/*scale=*/0.00024414062, /*zp=*/0,
                                      /*symmetry=*/true};
...
NodeQuantizationParameters Get2X2Int16LstmQuantizationSettings_CustomTest2() {
  NodeQuantizationParameters quantization_settings;
  quantization_settings.activation_type = kTfLiteInt16;
  quantization_settings.weight_type = kTfLiteInt8;
  quantization_settings.cell_type = kTfLiteInt16;
  ...
  // state quantization parameters
  quantization_settings.input = {/*scale=*/3.0518044e-6, /*zp=*/0,
                                 /*symmetry=*/true};
  quantization_settings.output = {/*scale=*/2.1362956633198035, /*zp=*/0,
                                  /*symmetry=*/true};
  quantization_settings.hidden_state = {/*scale=*/2.1362956633198035e-03,
                                        /*zp=*/0,
                                        /*symmetry=*/true};
  quantization_settings.cell_state = {/*scale=*/0.024414062, /*zp=*/0,
                                      /*symmetry=*/true};
  ...
  quantization_settings.forget_gate = {
      {/*scale=*/0.15748031496062992, /*zp=*/0, /*symmetry=*/true},
      {/*scale=*/0.15748031496062992, /*zp=*/0, /*symmetry=*/true},
      {/*scale=*/4.8059911474468205e-1, /*zp=*/0, /*symmetry=*/true}};
  quantization_settings.input_gate = {
      {/*scale=*/0.15748031496062992, /*zp=*/0, /*symmetry=*/true},
      {/*scale=*/0.15748031496062992, /*zp=*/0, /*symmetry=*/true},
      {/*scale=*/4.8059911474468205e-1, /*zp=*/0, /*symmetry=*/true}};
  quantization_settings.cell_gate = {
      {/*scale=*/0.07874015748031496, /*zp=*/0, /*symmetry=*/true},
      {/*scale=*/0.07874015748031496, /*zp=*/0, /*symmetry=*/true},
      {/*scale=*/2.40299557372341e-1, /*zp=*/0, /*symmetry=*/true}};
  quantization_settings.output_gate = {
      {/*scale=*/0.07874015748031496, /*zp=*/0, /*symmetry=*/true},
      {/*scale=*/0.07874015748031496, /*zp=*/0, /*symmetry=*/true},
      {/*scale=*/2.40299557372341e-1, /*zp=*/0, /*symmetry=*/true}};
...
NodeQuantizationParameters Get2X2Int16LstmQuantizationSettings_CustomTest3() {
  NodeQuantizationParameters quantization_settings;
  quantization_settings.activation_type = kTfLiteInt16;
  quantization_settings.weight_type = kTfLiteInt8;
  quantization_settings.cell_type = kTfLiteInt16;
  ...
  // state quantization parameters
  quantization_settings.input = {/*scale=*/5.0518044e-5, /*zp=*/0,
                                 /*symmetry=*/true};
  quantization_settings.output = {/*scale=*/2.1399519748035e-3, /*zp=*/0,
                                  /*symmetry=*/true};
  quantization_settings.hidden_state = {/*scale=*/2.03971362958035e-02,
                                        /*zp=*/0,
                                        /*symmetry=*/true};
  quantization_settings.cell_state = {/*scale=*/0.024414062, /*zp=*/0,
                                      /*symmetry=*/true};
