...
extern int8_t output_quantized1x16x16x12[];
extern int8_t golden_quantized1x16x16x12[];
extern const float kConvInput1x16x16x32Golden1x16x16x12[];
...
// Kernel Conv Test Case: Int8Input1x16x16x28Filter12x3x3x28PaddingSame
extern int8_t input_quantized1x16x16x28[];
extern int8_t filter_quantized12x1x16x16x28[];
extern int8_t output_quantized1x16x16x12[];
extern int8_t golden_quantized1x16x16x12[];
extern int32_t bias_quantized16x16x28Inp[];
extern const float kConvInput1x16x16x28Golden1x16x16x12[];

// Kernel Conv Test Case: Int8Input1x15x15x35Filter12x3x3x35PaddingSame
extern int8_t input_quantized1x15x15x35[];
extern int8_t filter_quantized12x1x15x15x35[];
extern int8_t output_quantized1x15x15x12[];
extern int8_t golden_quantized1x15x15x12[];
extern int32_t bias_quantized15x15x35Inp[];
extern const float kConvInput1x15x15x35Golden1x15x15x12[];

//Kernel Conv Test Case: Int8Input1x17x17x16Filter10x3x3x16Stride2x2ShouldMatchGolden
extern const float kConvInput1x17x17x16Golden1x8x8x10Stride2x2[];

//Conv Test Case: Int8Input1x15x15x35Filter12x3x3x35Stride2x2PaddingShouldMatchGolden
extern const float kConvInput1x15x15x35Golden1x6x6x12Stride2x2[1 * 6 * 6 * 12];

//Conv Test Case: Int8Input1x15x15x32Filter12x3x3x32Stride2x2ShouldMatchGolden
//int8_t output_quantized1x15x15x12[1*15*15*12];   // [N,H,W,num_filter]
//int8_t golden_quantized1x15x15x12[1*15*15*12];
extern int8_t input_quantized1x15x15x32[1*15*15*32];  // [len,N,H,W,C]
extern int8_t filter_quantized12x1x15x15x32[12*1*15*15*32];   // [num_filter,N,H,W,C]
extern int32_t bias_quantized15x15x32Inp[12];
extern const float kConvInput1x15x15x32Golden1x7x7x12Stride2x2[1 * 7* 7 * 12];

//Conv Test Case: Int8Input1x15x15x35Filter12x3x3x32Stride2x2ShouldMatchGolden
extern const float kConvInput1x15x15x35Golden1x7x7x12Stride2x2[1 * 7* 7 * 12];
